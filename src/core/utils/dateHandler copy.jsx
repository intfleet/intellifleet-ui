...
const getDateForDatePicker = (value) => {
    ...
    if (!value || value === "") {
        return getFormattedDate(DATE_PICKER_FORMAT);
    }
    return value;
}

const getTimeForTimePicker = (value) => {

    if (!value || value === "") {
        return getFormattedTime(TIME_PICKER_FORMAT);
    }
    return value;
}
...
const getDateTimeForDateTimePicker = (value) => {

    if (!value || value === "") {
        let date = moment();
        value  = date.format(DATE_TIME_PICKER_FORMAT);
    }
    return value;
}
