...
import { TextField } from '../../../core/components/form-generator/fields';
    ...
    >
        <Box style={styles.root}>
            <Grid container spacing={3}>
                <Grid item xs={12} style={styles.header}>{objectLabel} Filter</Grid>
                <Grid item xs={4} >
                    <select style={styles.select} onChange={e => handleSelect(e.currentTarget.value)} title={fieldValue ? fieldValue : ""}>
                ...
                <Grid item xs={12} style={styles.actionContainer}>
